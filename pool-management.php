        ...
        <td height="35" align="left" valign="bottom"><table width="100%">
            <tr>
              <td align="left"><input name="publish" lang="publish" class="button-primary" value="<?php echo @$submittext?>" type="submit" />
				...
				<input name="Help" lang="publish" class="button-primary" onclick="window.open('http://www.gopipulse.com/work/2012/03/19/pool-one-wp-wordpress-plugin/');" value="Help" type="button" />
              </td>
            </tr>
          </table></td>
      </tr>
...
<a target='_blank' href='http://www.gopipulse.com/work/2012/03/19/pool-one-wp-wordpress-plugin/'>Click here</a></span>
  </div>
</div>